...
/*   Updated: 2018/12/18 11:44:43 by gmelisan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		save_next_line(char *buf, const int fd, char **line)
{
	int		ret;
	int		endl;
	int		read_flag;
...
int		handle_buf(char *buf, const int fd, char **line)
{
	int		endl;
	int		ret;
	int		start;
...
void	ft_lstremove(t_list **list, t_list *item)
{
	t_list	*i;
	t_list	*prev;
